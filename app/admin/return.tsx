...
const STATUS_OPTIONS = ["lost", "returned"];
    ...
    return (
      <View style={styles.card}>
        {item.book?.coverImage ? (
          <Image
            source={{ uri: item.book?.coverImage ?? undefined }}
    ...
    <View style={styles.container}>
      ...
      >
        <TouchableOpacity
          ...
          onPress={() => router.push("/admin/scan-return" as any)}
        >
          <Ionicons
            ...
            style={{ marginRight: 8 }}
          />
          <Text style={styles.actionButtonText}>Scan QR to Set Status</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
