...
export default function HomeScreen() {
  ...
  const mainBgColor = isDarkMode ? "#111827" : "#F8FAFC";
  const textColor = isDarkMode ? "#F9FAFB" : "#111";
  const headerSectionBg = isDarkMode ? "#1E3A8A" : "#007AFF"; // Darker blue header

  return (
    <View style={[styles.mainContainer, { backgroundColor: mainBgColor }]}>
      <ScrollView bounces={false} contentContainerStyle={styles.scrollContent}>
        {/* Blue Header Section */}
        <View
          style={[styles.headerSection, { backgroundColor: headerSectionBg }]}
        >
          <SafeAreaView>
        ...
        <View style={styles.contentSection}>
          <Text style={[styles.sectionTitleDark, { color: textColor }]}>
            Popular Books
          </Text>
          <ScrollView
            horizontal
          ...
          <Text style={[styles.sectionTitleDarkRight, { color: textColor }]}>
            Recent Books
          </Text>
          <ScrollView
            horizontal
