...
export default function BookDetailScreen() {
  ...
  const isBookmarked = useAppStore((state) =>
    state.isBookmarked(bookId as Id<"books">),
  );
  ...
  return (
    <SafeAreaView style={[styles.safeArea, { backgroundColor: bgColor }]}>
      ...
      >
        ...
        <View style={[styles.stockBadge, { borderColor }]}>
        ...
        <View style={styles.sectionContainer}>
          ...
          <Text style={[styles.descriptionText, { color: descColor }]}>
            "{book.title}" adalah buku karya {book.author}.{" "}
            {book.subject
              ? `Buku ini membahas tentang ${book.subject}.`
              : "Silakan mengeksplorasi cerita atau materi yang ada di dalam buku ini di perpustakaan."}
          </Text>
        </View>

        {recommendations.length > 0 && (
          <View style={styles.sectionContainer}>
            <Text style={[styles.sectionTitleRight, { color: textColor }]}>
              Reccomendation
            </Text>
            <View style={styles.gridContainer}>
              {recommendations.map((rec) => (
                ...
                >
                  ...
                  <Text
                    style={[styles.recTitle, { color: textColor }]}
                    numberOfLines={2}
                  >
                    {rec.title}
                  </Text>
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            router.push({
              ...
              params: {
                bookId: book._id,
                duration: duration, // ← tambah ini
                dueDate: dueDate.getTime(), // ← tambah ini
              },
            })
          }
        >
